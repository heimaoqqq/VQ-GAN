    ...
    def forward(self, x, t_emb=None, context=None):
        ...
        for i in range(self.num_layers):
            ...
            if self.cross_attn:
                ...
                in_attn = in_attn.transpose(1, 2)
                assert context.shape[0] == x.shape[0], "Batch size mismatch between input and context"
                assert context.shape[-1] == self.context_dim, f"Context dimension mismatch: got {context.shape[-1]}, expected {self.context_dim}"
